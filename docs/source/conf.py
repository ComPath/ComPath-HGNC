...
htmlhelp_basename = 'ComPathHGNCdoc'
...
latex_documents = [
    (master_doc, 'ComPathHGNC.tex', 'ComPath HGNC Documentation',
...
man_pages = [
    (master_doc, 'compath_hgnc', 'ComPath HGNC Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ComPathHGNC', 'ComPath HGNC Documentation',
     author, 'ComPath HGNC', 'ComPath HGNC',
     'Miscellaneous'),
]
